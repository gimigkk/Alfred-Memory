...
1. **Mandatory Documentation Update**: Before finishing a session, you MUST update `Alfred.md` and the current Phase Plan if you have:
   - Completed a major feature or checklist item.
   - Changed a database schema or added new properties to nodes/edges.
   - Altered the architectural flow.
2. **Keep it Clean**: Ensure the documentation remains concise, accurate, and free of redundant information. Delete deprecated plans if they are no longer relevant.
3. **Commit State**: Remind the user to commit the documentation updates.
